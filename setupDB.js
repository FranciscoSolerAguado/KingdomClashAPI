...
db.serialize(() => {
    ...
    stmt.run("Ratcher", 25, 7, "Meticulosos y escurridizos, esta compañia de roedores disparará a distancia con una precisión increible.");
    ...
    stmt.run("Solid Snake", 100, 13, "Infantería media y tenaz de las fuerzas pantanosas, expertas en terrenos boscosos y pantanos. Avanza sin piedad tras su robusto escudo.");
    ...
    stmt.run("Guardian del Pantano", 2000, 50, "Se habla mucho de estos colosos escamosos y nada bueno, entre tantas, nunca nadie ha conseguido matar a alguno de ellos, se dice que no existen mas de 15.");
    stmt.run("Nutria Gigante", 150, 20, "Pescadores muy duros que han adaptado su arpón dentado para lanzarlo a distancia media al enemigo.");
    stmt.run("Tirachinas", 40, 4, "Pequeños y equipados con un tirachinas, la distancia a la que pueden atacar es inhumana y son muy molestos, les gusta matar Mineros del Reino.");
